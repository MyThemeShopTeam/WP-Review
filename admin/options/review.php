...
<div data-nav-tabs>
	...
	<div class="wp-review-field wp-review-rating-image <?php if(!$rating_image) echo 'hide'; ?>">
		...
		<div class="wp-review-field-option">
			<div class="img-wrapper <?php if(!$rating_image) echo 'hide'; ?>">
				<?php
				$rating_img_src = '';
			...
			<button class="set_rating_image button <?php if($rating_image) echo 'hide'; ?>"><?php _e('Set Image', 'wp-review'); ?></button>
		</div>
