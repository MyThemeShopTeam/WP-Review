				...
				<?php if ( $show_review_desc ) : ?>
					<?php if ( ! empty( $review['total'] ) ) :
						...
						<div class="review-total-wrapper">
							<span class="review-total-box"><h5><?php esc_html_e( 'Overall ', 'wp-review' ); ?></h5><div class="r-total"><?php echo $total_text; ?></div></span>
						</div>
					<?php endif; ?>
...
<style type="text/css">
	...
	.wp-review-<?php echo $review['post_id']; ?>.review-wrapper .review-total-wrapper span.review-total-box { padding: 0; }
	...
	.wp-review-<?php echo $review['post_id']; ?>.review-wrapper .review-total-wrapper span.review-total-box .r-total {
		float: right;
		background: <?php echo $colors['color']; ?>;
		font-size: 18px;
		line-height: 44px;
